        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4 flex-wrap">
            ...
            <p className="text-md md:text-lg lg:text-lg text-gray-600 flex-wrap">
              NoteLock is a powerful and user-friendly application that helps
              you store and manage your sensitive information securely.
            </p>
            <div className="flex gap-4">
              <Button onClick={handleGetStarted} className="w-1/2">
                Get Started
              </Button>
            </div>
          </div>
